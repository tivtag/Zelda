...
namespace Zelda.Editor.Object.PropertyWrappers
{
    ...
    internal sealed class PositionalSoundEmitterPropertyWrapper : EntityPropertyWrapper<PositionalSoundEmitter>
    {
        #region > Transform <
        ...
        {
            return new PositionalSoundEmitterPropertyWrapper( serviceProvider );
        }
        ...
        /// </param>
        public PositionalSoundEmitterPropertyWrapper( IZeldaServiceProvider serviceProvider )
        {
