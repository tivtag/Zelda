// <copyright file="FixedShadowSpellDamageMethod.cs" company="federrot Software">
//     Copyright (c) federrot Software. All rights reserved.
// </copyright>
// <summary>
//     Defines the Zelda.Attacks.FixedShadowSpellDamageMethod class.
// </summary>
...
namespace Zelda.Attacks.Methods
{
    ...
    /// </summary>
    public sealed class FixedShadowSpellDamageMethod : AttackDamageMethod
    {
        /// <summary>
        ...
        {
            if( target.Resistances.TryResist( ElementalSchool.Shadow ) )
