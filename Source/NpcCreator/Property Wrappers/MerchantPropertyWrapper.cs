// <copyright file="MerchantPropertyWrapper.cs" company="federrot Software">
//     Copyright (c) federrot Software. All rights reserved.
// </copyright>
// <summary>Defines the Zelda.NpcCreator.MerchantPropertyWrapper class.</summary>
...
namespace Zelda.NpcCreator
{
    ...
    /// <summary>
    /// Defines the IObjectPropertyWrapper for <see cref="Merchant"/> entities.
    /// </summary>
    sealed class MerchantPropertyWrapper : NpcPropertyWrapper<Merchant>
    {
        [LocalizedDisplayName( "PropDisp_SellList" )]
        [LocalizedCategory( "PropCate_Merchant" )]
        [LocalizedDescription( "PropDesc_SellList" )]
        public IMerchantSellList SellList
        {
            get
            {
                return this.WrappedObject.SellList;
            }
        }
        ...
        public LocalizableText LocalizedName
        {
            get
            {
                return this.WrappedObject.LocalizedName;
            }
        }
        ...
        public float MovementSpeed
        {
            get
            {
                return this.WrappedObject.Moveable.Speed; 
            }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantPropertyWrapper"/> class.
        /// </summary>
        /// <param name="serviceProvider">
        /// Provides fast access to game-related services.
        /// </param>
        public MerchantPropertyWrapper( IZeldaServiceProvider serviceProvider )
        {
        ...
        /// <summary>
        /// Returns a clone of this MerchantPropertyWrapper.
        /// </summary>
        /// <returns>The cloned MerchantPropertyWrapper.</returns>
        public override Atom.Design.IObjectPropertyWrapper Clone()
        {
            return new MerchantPropertyWrapper( serviceProvider );
        }
