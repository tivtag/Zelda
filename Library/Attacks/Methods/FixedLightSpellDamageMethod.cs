// <copyright file="FixedLightSpellDamageMethod.cs" company="federrot Software">
//     Copyright (c) federrot Software. All rights reserved.
// </copyright>
// <summary>
//     Defines the Zelda.Attacks.FixedLightSpellDamageMethod class.
// </summary>
...
namespace Zelda.Attacks.Methods
{
    ...
    /// </summary>
    public sealed class FixedLightSpellDamageMethod : AttackDamageMethod
    {
        /// <summary>
        ...
        {
            if( target.Resistances.TryResist( ElementalSchool.Light ) )
