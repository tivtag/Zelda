...
technique GaussianBlurH
{
    pass p0
    {
        ...
        PixelShader = compile ps_2_0 HGaussianBlurShader(6, false);
...
technique GaussianBlurV
{
    ...
    {
        VertexShader = compile vs_2_0 PostProcessVS();
        PixelShader = compile ps_2_0 VGaussianBlurShader(6, false);
...
technique GaussianBlurEncodeH
{
    pass p0
    {
        ...
        PixelShader = compile ps_3_0 HGaussianBlurShader(6, true);
...
technique GaussianBlurEncodeV
{
    ...
    {
        VertexShader = compile vs_3_0 PostProcessVS();
        PixelShader = compile ps_3_0 VGaussianBlurShader(6, true);
