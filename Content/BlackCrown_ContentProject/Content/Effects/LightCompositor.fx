...
technique Normal
{
    pass Pass1
    {
        ...
        vertexShader     = compile vs_4_0 ComposeVertexShader();
        pixelShader      = compile ps_4_0 ComposePixelShader();
    }
}
...
technique FullBright
{
    pass Pass1
    {
        ...
        DestBlend        = InvSrcAlpha;
        vertexShader     = compile vs_4_0 ComposeVertexShader();
        pixelShader      = compile ps_4_0 FullBrightPixelShader();
    }
}
...
technique LightOnly
{
    pass Pass1
    {
        ...
        DestBlend        = InvSrcAlpha;
        vertexShader     = compile vs_4_0 ComposeVertexShader();
        pixelShader      = compile ps_4_0 LightOnlyPixelShader();
    }
}
